...
window.addEventListener('click', e => {
  ...
  if (!target.closest('.icon-menu') && !target.closest('.header')) { // если этот элемент или его родительские элементы не окно навигации и не кнопка

    iconMenu.classList.remove("_active");
    menuBody.classList.remove("active-menu"); // то закрываем окно навигации, удаляя активный класс
  }
})
//=================
//BodyLock
